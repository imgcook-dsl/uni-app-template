简体中文 | [English](https://github.com/imgcook-dsl/uni-app-template/blob/master/README.md)
...
### 使用第三方 DSL
如果要使用其他开发者开发的 DSL 需要去 [DSL广场](https://www.imgcook.com/dsl)收藏(如图)，收藏后会在生成代码 DSL 选择列表中出现。
<br/><br/>
